...
<b> • 𝐇𝐞𝐚𝐫𝐭𝐁𝐞𝐚𝐭-✗-𝐁𝐨𝐭 :</b> {message.from_user.mention}
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            reply_markup=InlineKeyboardMarkup(
                [[InlineKeyboardButton("──「 𝐇𝐞𝐚𝐫𝐭𝐁𝐞𝐚𝐭-✗-𝐁𝐨𝐭 」──", callback_data="helper")]]
            ),
        )
    )
    return answers
...
async def help_function(answers):
    ...
    answers.append(
        InlineQueryResultArticle(
            ...
            thumb_url="https://graph.org/file/9ee37cccd7bf55c3ec953.png",
            input_message_content=InputTextMessageContent(
