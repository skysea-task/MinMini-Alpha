...
async def hello(client: app, message):
    buttons = [
           [
                InlineKeyboardButton("⚡𝙾𝚆𝙽𝙴𝚁 💕⚡", url="t.me/rajeshrakis"),
            ],
            [
                InlineKeyboardButton("⚡𝙲𝙷𝙰𝙽𝙽𝙴𝙻 💕⚡", url="t.me/HeartBeat_Offi"),
            ],
            [
                InlineKeyboardButton("⚡𝚂𝚄𝙿𝙿𝙾𝚁𝚃 💕⚡", url="t.me/HeartBeat_Muzic"),
            ],
            ]
...
async def clone(bot: app, msg: Message):
    ...
    try:
        ...
        await msg.reply(f" Try to Join 𝐇𝐞𝐚𝐫𝐭𝐁𝐞𝐚𝐭  {user.first_name} 💨.")
