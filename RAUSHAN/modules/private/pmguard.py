...
@Client.on_message(filters.command(["a", "ap", "approve", "allow"], ["."]) & filters.me & filters.private)
...
@Client.on_message(filters.command(["da", "dap", "disapprove", "deny"], ["."]) & filters.me & filters.private)
